...
<?php
        ...
        if(isset($_SESSION['nick'])){
            ...
            exit();
             ...
             $sql="SELECT * FROM juego_nico WHERE persona='$nick'";
             $consulta = mysqli_query($conexion,$sql);

             $sql2="SELECT * FROM puff_nico";
                    ...
                    <tbody>
                        <tr>
                            ...
                            while ($fila2 = mysqli_fetch_assoc($consulta2)) {
                                echo "<td>" . $fila2['opcion1'] . "</td>"; 
                                echo "<td>" . $fila2['opcion2'] . "</td>";   
                                echo "<td>" . $fila2['opcion3'] . "</td>";   
                                echo "<td>" . $fila2['opcion4'] . "</td>";   
                                echo "<td>" . $fila2['opcion5'] . "</td>";   
